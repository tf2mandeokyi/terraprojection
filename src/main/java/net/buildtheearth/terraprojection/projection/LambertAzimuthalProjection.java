...
/**
 * @see <a href="https://mathworld.wolfram.com/LambertAzimuthalEqual-AreaProjection.html">Wolfram - Lambert Azimuthal Equal-Area Projection</a>
 */
@Getter
@JsonAdapter(LambertAzimuthalProjection.Deserializer.class)
public class LambertAzimuthalProjection implements GeographicProjection {
    ...
    public LambertAzimuthalProjection(Double centerX, Double centerY) {
        this.centerX = modDegrees(centerX != null ? centerX : 0.0d, 360.0d);
        this.centerY = modDegrees(centerY != null ? centerY : 0.0d, 180.0d);
    }

    static class Deserializer implements JsonDeserializer<LambertAzimuthalProjection> {
        public LambertAzimuthalProjection deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            JsonObject jsonObject = json.getAsJsonObject();
            return new LambertAzimuthalProjection(
